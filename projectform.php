...
if($_SERVER["REQUEST_METHOD"] == "POST"){
  ...
  if(empty(trim($_POST["approved"]))){
    //error declaration
    $appoved_err = "Please input answer for this question.";
  } else {
    //variable declaration
    $appoved = trim($_POST["approved"]);
  }
...
<!-- Organization Employee-->
    ...
    <div>
      ...
      <input type="text" name="approved" id="approved" value="<?php echo $appoved; ?>">
      <span class="help-block"><?php echo $appoved_err; ?></span>
    </div>
